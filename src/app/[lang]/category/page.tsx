...
const categories: Category[] = [
  ...
  { key: "jpop",    label: "Anime",     emoji: <span className="fi fi-jp"></span>, gradient: "from-rose-400/40 via-pink-500/15 to-violet-700/20",   ring:"ring-rose-300/40",    desc: "Anime songs & theme music from popular series" },
  ...
  { key: "western", label: "Western",  emoji: <span className="fi fi-us"></span>, gradient: "from-indigo-400/40 via-violet-600/20 to-amber-500/25", ring:"ring-indigo-300/40",  desc: "Top Western pop from Taylor Swift, Dua Lipa!" },
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-3 mb-4">
            <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-[10px] font-semibold tracking-wider uppercase bg-white/5 border border-white/10 text-white/60 backdrop-blur animate-[fadeIn_.9s_ease]">{difficulty==='hardcore' ? t('hardcore') : t('casual')} {t('mode')}</span>
          </div>
